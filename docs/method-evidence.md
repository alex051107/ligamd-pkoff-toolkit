...
| Chemically typed interaction fingerprints | Bouysset and Fiorucci (2021), [doi:10.1186/s13321-021-00548-6](https://doi.org/10.1186/s13321-021-00548-6) | No page or figure locator is retained in the public source record | Protein–ligand interaction fingerprints can encode named interaction types rather than only an untyped proximity event. | One typed-interaction block is a future challenger. It must be compared with a matched untyped block. Current30 contains no typed-interaction block and no claim of typed-feature benefit. |
